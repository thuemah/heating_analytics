...
def mock_coordinator():
    ...
    with patch("custom_components.heating_analytics.storage.Store"):
        ...
        # Mode-stratified per #868: heating regime carries the test's
        # configured coefficient; cooling regime is zero (test never
        # exercises cooling mode).
...
# =============================================================================
# Extended-type handling — SolarCalculator must accept float and str inputs
# for both apply_correction and normalize_for_learning so HA-state values
# (often delivered as strings) don't crash the pipeline.
# =============================================================================
