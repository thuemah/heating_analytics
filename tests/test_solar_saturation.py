"""Tests for solar-saturation accounting in StatisticsManager — including the
partial-aux case where a known aux reduction must still be subtracted from
demand even when ``is_aux_active`` is False on the live snapshot."""
import pytest
...
def coordinator(mock_hass):
    ...
    # used by the partial-aux test below).
